...
<div class="mb-3">
  <label for="numeroRastreoMexInput" class="form-label">Número de rastreo en México (Pendiente)</label>
...
<div class="mb-3">
  <label for="registroSalidaInput" class="form-label">Registro de salida (Pendiente)</label>
...
<div class="mb-3">
  <label class="form-label" for="nombreContactoInput">Nombre del contacto (Opcional)</label>
    <input type="text" class="form-control {{ bsIsInvalidClass('nombre_contacto') }}" id="nombreContactoInput" name="nombre_contacto" value="{{ old('nombre_contacto', ($direccion?->prellenados['nombre_contacto'] ?? $guia->nombre_contacto) ) }}">
...
<div class="mb-3">
  <label class="form-label" for="telefonoContactoInput">Teléfono del contacto (Opcional)</label>
    <input type="text" class="form-control {{ bsIsInvalidClass('telefono_contacto') }}" id="telefonoContactoInput" name="telefono_contacto" value="{{ old('telefono_contacto', ($direccion?->prellenados['telefono_contacto'] ?? $guia->telefono_contacto) ) }}">
